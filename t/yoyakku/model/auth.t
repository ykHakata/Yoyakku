...
BEGIN { use_ok('Yoyakku::Model::Auth') || print "Bail out!\n"; }
...
subtest 'method' => sub {
    my $obj = Yoyakku::Model::Auth->new();
    isa_ok( $obj, 'Yoyakku::Model::Auth' );

    my @methods = qw{logged_in get_logged_in_row login};
